...
function avanzar2(){
  ...
  function hablaer(){
    speechSynthesis.speak(new SpeechSynthesisUtterance("project two options one world please click start 3d model, created by Daniel Isai Mas Cach and Daniel Aldayr Suastes Pech"));
  }
